...
const sampleQuestions = {
  1: [
    ...
    // { id: 2, question: "What was the company's total revenue growth in 2024?", options: ["30% year-over-year increase", "20% year-over-year increase", "30% year-over-year increase", "30% year-over-year increase"] },
    { id: 1, question: "What was the company's total revenue growth in 2024?", options: ["30% year-over-year increase", "20% year-over-year increase", "30% year-over-year increase", "30% year-over-year increase"] }
  ],
  1: [
    ...
    <div className="question-container">
      ...
      <div className="main-content">
        <div className="top-bar">
          <IoMdMenu size={30} onClick={() => setMenuOpen(true)} />
          <h2>{report.title}</h2>
        ...
        <div className="progress-bar">
          {[1, 2, 3, 4].map((step) => (
            <span key={step} className={`step ${step === 1 ? "active" : ""}`}>
              {step}
            </span>
          ))}
        </div>
